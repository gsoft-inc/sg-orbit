...
<details><summary className="outline-0">or you can write a custom one</summary>
...
<details classNam="outline-0"><summary className="outline-0">specify optional data</summary>
