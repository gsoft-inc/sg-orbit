...
An icon component allow you to render a custom SVG icon (e.g. Azure specific icons) with Orbit Design standardize sizes. When using an icon component, the SVG icon will be rendered as an inline `svg` element. There are several advantages to do it this way, some are highlighted in this [article](https://www.jotform.com/blog/why-you-should-embed-svg-inline-98570/).

For Orbit UI official icons, please have a look at the [icons page](?path=/docs/materials-icons--page#gallery) in the materials section.
