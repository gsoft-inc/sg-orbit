...
const SPACE_BETWEEN_ROWS = "25px";
const SPACE_BETWEEN_COLUMNS = "50px";
...
function Icons({ element, ...rest }) {
    ...
    return (
        <>
            <div className="flex items-end" style={{ marginBottom: SPACE_BETWEEN_ROWS }}>
            ...
            <div className="flex" style={{ marginBottom: SPACE_BETWEEN_ROWS }}>
    ...
    return (
        <>
            ...
            <div className="flex" style={{ marginBottom: SPACE_BETWEEN_ROWS }}>
                ...
                <Button label={<Label>6</Label>} loading element={button} className="mr5">Button</Button>
            </div>
        </>
    );
}
...
export function createSharedStories(button, stories) {
    return stories
        .add("default", () =>
            <div className="flex">
                <div className="flex flex-column" style={{ marginRight: SPACE_BETWEEN_COLUMNS }}>
                    <div className="flex" style={{ marginBottom: SPACE_BETWEEN_ROWS }}>
