...
import { isNullOrEmpty, useHandlerProxy } from "@orbit-ui/react-components-shared";
import cx from "classnames";

class DatePickerTextboxInputInner extends PureComponent {
    static propTypes = {
    ...
    render() {
        const { value, placeholder, disabled, triggerRef } = this.props;
...
export const DatePickerTextboxInput = forwardRef((props, ref) => {
    return <DatePickerTextboxInputInner { ...props } triggerRef={ref} />;
});
