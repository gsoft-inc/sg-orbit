...
It is important to note that moment instances are mutable. Calling any of the manipulation methods will change the original moment. If you need to manipulate an instance, [make a clone first](https://momentjs.com/docs/#/parsing/moment-clone/).
