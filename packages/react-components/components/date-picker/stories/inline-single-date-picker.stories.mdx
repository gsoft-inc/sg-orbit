...
<Message info size="small">This component have the same feature set as the <a href="/?path=/docs/components-date-picker-single--default-story">SingleDatePicker</a> component. Only the input differs.</Message>
...
A basic inlined single date picker.
