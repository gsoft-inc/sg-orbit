...
<Message info size="small">This component have the same features as the <a href="/?path=/docs/components-date-picker-single--default-story">SingleDatePicker</a> component. Only the input differs.</Message>
