...
import { ControlledDateRangePicker, FileSource } from "./components";
...
<FileSource filePath="!!raw-loader!@root/packages/react-components/components/date-picker/stories/date-range-picker/components/controlled-date-range-picker.jsx" />
