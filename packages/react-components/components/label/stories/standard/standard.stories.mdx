...
A label can contain a [button](?path=/docs/components-button--default-story).
...
A label can contain an [icon](?path=/docs/materials-icons--page).
...
A label can contain a [tag](?path=/docs/components-label-tag--default-story).
