...
function (_PureComponent) {
  ...
  function Popup() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleOutsideClick", function (event) {
      ...
      if (!_this._containerRef.current.contains(event.target)) {
        if (!(0, _lodash.isNil)(onOutsideClick)) {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleKeyDown", function (event) {
      var onEscapeKeyDown = _this.props.onEscapeKeyDown;

      if (event.keyCode === KEYS.esc) {
        if (!(0, _lodash.isNil)(onEscapeKeyDown)) {
  ...
  _createClass(Popup, [{
    ...
    value: function getPositioningStyle() {
      ...
      if (!(0, _lodash.isNil)(top)) {
        positions.top = top;
      }

      if (!(0, _lodash.isNil)(bottom)) {
        positions.bottom = bottom;
      }

      if (!(0, _lodash.isNil)(left)) {
        positions.left = left;
      }

      if (!(0, _lodash.isNil)(right)) {
...
_defineProperty(Popup, "propTypes", {
  ...
  onOutsideClick: _propTypes.func,
  onEscapeKeyDown: _propTypes.func,
