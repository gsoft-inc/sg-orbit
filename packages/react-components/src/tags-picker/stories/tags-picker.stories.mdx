...
import { DEFAULT_SIZE, TagsPicker, tagsPickerItem } from "@react-components/tags-picker";
...
>
    <TagsPicker
        ...
        noResultsMessage={text("noResultsMessage", TagsPicker.defaultProps.noResultsMessage)}
        triggerText={text("triggerText", TagsPicker.defaultProps.triggerText)}
        placeholder={text("placeholder", TagsPicker.defaultProps.placeholder)}
        clearText={text("clearText", TagsPicker.defaultProps.clearText)}
