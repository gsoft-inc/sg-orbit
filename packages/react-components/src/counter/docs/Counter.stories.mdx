...
A counter indicate a running tally. A counter is normally embedded in another component such as a [tag](?path=/docs/tag--default-story) or a [checkbox](?path=/docs/checkbox--default-story).
