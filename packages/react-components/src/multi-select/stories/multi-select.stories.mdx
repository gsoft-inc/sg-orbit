...
export const MERCURY_VALUE = "mercury";
export const GEMINI_VALUE = "gemini";
export const APOLLO_VALUE = "apollo";
export const SKYLAB_VALUE = "skylab";
export const SOYUZ_VALUE = "soyuz";
export const ARTEMIS_VALUE = "artemis";

export const DEFAULT_ITEMS = [
    multiSelectItem("Mercury Program", MERCURY_VALUE),
    multiSelectItem("Gemini Program", GEMINI_VALUE),
    multiSelectItem("Apollo Program", APOLLO_VALUE),
    multiSelectItem("Skylab", SKYLAB_VALUE),
    multiSelectItem("Apollo–Soyuz Test Project", SOYUZ_VALUE),
    multiSelectItem("Artemis Program", ARTEMIS_VALUE)
];

export const DEFAULT_ITEMS_WITH_CATEGORIES = [
    multiSelectItem("Mercury Program", MERCURY_VALUE, "1950"),
    multiSelectItem("Gemini Program", GEMINI_VALUE, "1960"),
    multiSelectItem("Apollo Program", APOLLO_VALUE, "1970"),
    multiSelectItem("Skylab", SKYLAB_VALUE, "1970"),
    multiSelectItem("Apollo–Soyuz Test Project", SOYUZ_VALUE, "1970"),
    multiSelectItem("Artemis Program", ARTEMIS_VALUE, "2010")
];

```js dark
const MERCURY_VALUE = "mercury";
const GEMINI_VALUE = "gemini";
const APOLLO_VALUE = "apollo";
const SKYLAB_VALUE = "skylab";
const SOYUZ_VALUE = "soyuz";
const ARTEMIS_VALUE = "artemis";
...
>
    <MultiSelect
        ...
        defaultValues={[SKYLAB_VALUE, GEMINI_VALUE]}
...
<Preview>
    <Story name="default values">
        <MultiSelect
            defaultValues={[GEMINI_VALUE, SKYLAB_VALUE]}
            items={DEFAULT_ITEMS}
            onValuesChange={logValuesChanged}
        />
    </Story>
...
<FilePreview filePath="/multi-select/stories/components/controlled-multi-select">
    <ControlledMultiSelect
        items={DEFAULT_ITEMS}
        values={[SKYLAB_VALUE, GEMINI_VALUE]}
        onValuesChange={logValuesChanged}
    />
</FilePreview>
