...
import { ErrorMessage, InfoMessage, InnerMessage, Message, MessageTemplate, PositiveMessage, WarningMessage } from "@react-components/message";
...
Use an info message to notify a user of a change that's relevant for them to achieve their current goal.

<Preview>
    <Story name="info">
        <InfoMessage onDismiss={() => {}}>
            <Content>Your email to <strong>booking@spacetravel.com</strong> has been sent!</Content>
            <Button>Undo</Button>
        </InfoMessage>
    </Story>
...
Use an error message to help a user understand a critical issue at the system level.
...
<ComponentInfo
    usage={"import { InfoMessage } from \"@orbit-ui/react-components\";"}
    slots={["content", "button"]}
    compact
/>

<ArgsTable of={MessageTemplate} sort="alpha" />

### PositiveMessage

<ComponentInfo
    usage={"import { PositiveMessage } from \"@orbit-ui/react-components\";"}
    slots={["content", "button"]}
    compact
/>
...
<ComponentInfo
    usage={"import { WarningMessage } from \"@orbit-ui/react-components\";"}
    slots={["content", "button"]}
    compact
/>
