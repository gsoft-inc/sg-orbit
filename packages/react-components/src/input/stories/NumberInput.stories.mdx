...
A number input can have additional text to further describe the input.

<Preview>
    <Story name="description">
        <NumberInput label="Age" description="We collect this information for anonymous statistical analysis." />
    </Story>
</Preview>
...
A number input can have an [icon](?path=/docs/materials-icons--page).
...
<Preview>
    <Story name="message">
        <Inline>
            <NumberInput helpMessage="How long ago are you born?" label="Age" fluid />
