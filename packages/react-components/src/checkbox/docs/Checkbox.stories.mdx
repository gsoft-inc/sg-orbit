...
<ComponentInfo
    usage={"import { Checkbox, CheckboxGroup, Text } from \"@orbit-ui/react-components\""}
    ariaPath="#checkbox"
...
<FileCanvas filePath="/checkbox/docs/CheckedValidation">
    <CheckedValidation />
</FileCanvas>
...
<FileCanvas filePath="/checkbox/docs/ControlledCheckbox">
    <ControlledCheckbox />
</FileCanvas>
...
<FileCanvas filePath="/checkbox/docs/AllCheckedValidation">
...
<FileCanvas filePath="/checkbox/docs/CustomGroup">
    <CustomGroup />
</FileCanvas>
...
<FileCanvas filePath="/checkbox/docs/ControlledCheckboxGroup">
...
<Story
    ...
    parameters={paramsBuilder()
        .component(InnerCheckbox)
        .excludeFromDocs()
        .build()}
>
    {args =>
        <InnerCheckbox {...args}>Milky Way</InnerCheckbox>
    }
</Story>
...
<ArgsTable of={InnerCheckboxGroup} />
