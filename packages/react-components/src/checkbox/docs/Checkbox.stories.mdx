    ...
    <Story name="wrap toggle buttons">
        <Div width="200px">
            <CheckboxGroup wrap gap={2}>
                <ToggleButton value="1" variant="secondary" shape="circular">1</ToggleButton>
                <ToggleButton value="2" variant="secondary" shape="circular">2</ToggleButton>
                <ToggleButton value="3" variant="secondary" shape="circular">3</ToggleButton>
                <ToggleButton value="4" variant="secondary" shape="circular">4</ToggleButton>
                <ToggleButton value="5" variant="secondary" shape="circular">5</ToggleButton>
                <ToggleButton value="6" variant="secondary" shape="circular">6</ToggleButton>
                <ToggleButton value="7" variant="secondary" shape="circular">7</ToggleButton>
                <ToggleButton value="8" variant="secondary" shape="circular">8</ToggleButton>
            </CheckboxGroup>
        </Div>
    </Story>
</Preview>
