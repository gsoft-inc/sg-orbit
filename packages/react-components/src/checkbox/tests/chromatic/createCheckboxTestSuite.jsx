        ...
        .add("labeled", () =>
            <Stack>
                <Inline verticalAlign="end">
                    ...
                    <Checkbox size="lg" element={element}>Milky Way</Checkbox>
                </Inline>
                <Inline verticalAlign="end">
                    ...
                    <Checkbox size="lg" element={element}>
                        <Text>Milky Way</Text>
                        <EmailIcon />
                    </Checkbox>
                </Inline>
