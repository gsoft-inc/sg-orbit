...
import { CheckeredBackground, InstallationReactComponents, Props, ReactComponentsLayout } from "@blocks";
...
<InstallationReactComponents componentFolder="icons" imports={<Imports />} />
