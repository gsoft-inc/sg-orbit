...
import { Icon, InnerIcon, InnerIconGroup, InnerMultiVariantIcon, MultiVariantIcon } from "@react-components/icons";
...
<Props
    componentsDefinitions={[
        ...
        { displayName: "IconGroup", component: InnerIconGroup }
    ]}
/>
...
<Story
    ...
    parameters={paramsBuilder()
        ...
        .build()}
>
    <RefLogger><HocAzureIcon32 /></RefLogger>
</Story>
...
<Story
    ...
    parameters={paramsBuilder()
        ...
        .build()}
>
    <RefLogger><HocFilterIcon /></RefLogger>
</Story>
