...
<Preview scope={{ AzureIcon32 }}>
    <Story name="dynamic-color">
        <CheckeredBackground>
            <Inline verticalAlign="end" gap={2}>
                <Icon src={AzureIcon32} size="lg" style={{ fill: "var(--o-ui-primary-100)" }} />
                <Icon src={AzureIcon32} size="lg" style={{ fill: "var(--o-ui-primary-500)" }} />
                <Icon src={AzureIcon32} size="lg" style={{ fill: "var(--o-ui-primary-900)" }} />
            </Inline>
        </CheckeredBackground>
    </Story>
</Preview>
