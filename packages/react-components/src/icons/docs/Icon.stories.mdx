...
import { CheckeredBackground, ComponentInfo } from "@stories/components";
...
<Canvas>
    <Story name="dynamic-color">
        <CheckeredBackground>
            <Inline verticalAlign="end" gap={2}>
                <Icon type={AzureIcon32} size="lg" style={{ fill: "var(--primary-100)" }} />
                <Icon type={AzureIcon32} size="lg" style={{ fill: "var(--primary-500)" }} />
                <Icon type={AzureIcon32} size="lg" style={{ fill: "var(--primary-900)" }} />
            </Inline>
        </CheckeredBackground>
    </Story>
</Canvas>
...
Component for icons without variants.
...
Component for multi-variants icons.
...
List component for a group of icons.
...
>
    {args =>
        <InnerIcon type={AzureIcon32} {...args} />
    }
</Story>

<Story
    name="playground - multi-variant icon"
    parameters={paramsBuilder()
        .component(InnerMultiVariantIcon)
        .excludeFromDocs()
        .build()}
>
    {args =>
        <MultiVariantIcon type24={FilterIcon24} type32={FilterIcon32} {...args} />
    }
</Story>
