...
<Preview scope={{ AzureIcon32 }}>
    <Story name="dynamic-color">
        <CheckeredBackground>
            <Inline verticalAlign="end" gap={2}>
                <Icon type={AzureIcon32} size="lg" style={{ fill: "var(--o-ui-alias-primary-100)" }} />
                <Icon type={AzureIcon32} size="lg" style={{ fill: "var(--o-ui-alias-primary-500)" }} />
                <Icon type={AzureIcon32} size="lg" style={{ fill: "var(--o-ui-alias-primary-900)" }} />
            </Inline>
        </CheckeredBackground>
    </Story>
</Preview>
