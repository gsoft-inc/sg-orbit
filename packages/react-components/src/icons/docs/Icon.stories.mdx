    ...
    <Story name="color">
        <CheckeredBackground>
            <Inline verticalAlign="end" gap={2}>
                <Icon src={AzureIcon32} size="lg" className="fill-primary-100" />
                <Icon src={AzureIcon32} size="lg" className="fill-primary-500" />
                <Icon src={AzureIcon32} size="lg" className="fill-primary-900" />
            </Inline>
        </CheckeredBackground>
    </Story>
</Preview>
...
<Preview scope={{ AzureIcon32 }}>
    <Story name="dynamic-color">
        <CheckeredBackground>
            <Inline verticalAlign="end" gap={2}>
                <Icon src={AzureIcon32} size="lg" style={{ fill: "var(--o-ui-alias-primary-100)" }} />
                <Icon src={AzureIcon32} size="lg" style={{ fill: "var(--o-ui-alias-primary-500)" }} />
                <Icon src={AzureIcon32} size="lg" style={{ fill: "var(--o-ui-alias-primary-900)" }} />
            </Inline>
        </CheckeredBackground>
    </Story>
</Preview>
...
<Preview scope={{ FilterIcon24, FilterIcon32 }}>
    <Story name="multi-variants color">
        <CheckeredBackground>
            <Inline verticalAlign="end" gap={2}>
                <MultiVariantIcon src24={FilterIcon24} src32={FilterIcon32} size="lg" className="fill-primary-100" />
                <MultiVariantIcon src24={FilterIcon24} src32={FilterIcon32} size="lg" className="fill-primary-500" />
                <MultiVariantIcon src24={FilterIcon24} src32={FilterIcon32} size="lg" className="fill-primary-900" />
            </Inline>
        </CheckeredBackground>
    </Story>
</Preview>
