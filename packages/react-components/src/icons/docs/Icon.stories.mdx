...
An icon color can be altered by specifying a stroke value with [Tachyons stroke classes](?path=/docs/materials-colors--page#tachyons):

<Preview scope={{ AzureIcon32 }}>
    <Story name="color">
        <CheckeredBackground>
            <Inline verticalAlign="end" gap={2}>
                <Icon type={AzureIcon32} size="lg" className="stroke-primary-100" />
                <Icon type={AzureIcon32} size="lg" className="stroke-primary-500" />
                <Icon type={AzureIcon32} size="lg" className="stroke-primary-900" />
            </Inline>
        </CheckeredBackground>
    </Story>
</Preview>
...
<Preview scope={{ AzureIcon32 }}>
    <Story name="dynamic-color">
        <CheckeredBackground>
            <Inline verticalAlign="end" gap={2}>
                <Icon type={AzureIcon32} size="lg" style={{ stroke: "var(--o-ui-alias-primary-100)" }} />
                <Icon type={AzureIcon32} size="lg" style={{ stroke: "var(--o-ui-alias-primary-500)" }} />
                <Icon type={AzureIcon32} size="lg" style={{ stroke: "var(--o-ui-alias-primary-900)" }} />
            </Inline>
        </CheckeredBackground>
    </Story>
</Preview>
...
<Preview>
    <Story name="multi-variants color">
        <CheckeredBackground>
            <Inline verticalAlign="end" gap={2}>
                <MultiVariantIcon type24={FilterIcon24} type32={FilterIcon32} size="lg" className="stroke-primary-100" />
                <MultiVariantIcon type24={FilterIcon24} type32={FilterIcon32} size="lg" className="stroke-primary-500" />
                <MultiVariantIcon type24={FilterIcon24} type32={FilterIcon32} size="lg" className="stroke-primary-900" />
            </Inline>
        </CheckeredBackground>
    </Story>
</Preview>
