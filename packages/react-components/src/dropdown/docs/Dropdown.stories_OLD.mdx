...
import { FolderIcon, HelpIcon, IconList, InfoIcon, SignoutIcon, VerticalDotsIcon, WarningIcon } from "@react-components/icons";
    ...
    <Story name="item icon">
        <Dropdown>
            ...
            <Dropdown.Menu>
                <Dropdown.ButtonItem onClick={logClicked}>Launch...</Dropdown.ButtonItem>
                <Dropdown.ButtonItem onClick={logClicked}>Eject...</Dropdown.ButtonItem>
                <Dropdown.ButtonItem iconLeft={<IconList><WarningIcon /><InfoIcon /></IconList>} onClick={logClicked}>Land...</Dropdown.ButtonItem>
