...
The previous [render props](#render-props) example could also be achieve by using `useAccordionContext`.

<Preview filePath="/accordion/docs/AccordionContext" noInline />
