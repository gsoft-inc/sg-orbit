...
If all you need is a hint that activating the button will display additional content you don't have to implement it yourself as in the 2 previous examples. You could instead use a [disclosure arrow](/) component.
