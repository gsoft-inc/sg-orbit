...
A few [API functions are available for a text input component](https://developer.mozilla.org/en-US/docs/Web/API/HTMLInputElement#Methods). To use an API, first get a [ref](https://reactjs.org/docs/refs-and-the-dom.html) on the text input component, then call the API function.
