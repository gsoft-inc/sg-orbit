...
import { InnerPasswordInput, InnerSearchInput, InnerTextInput, PasswordInput, SearchInput, TextInput } from "@react-components/text-input";
...
<ComponentInfo
    usage={"import { TextInput, SearchInput, PasswordInput } from \"@orbit-ui/react-components\";"}
...
<ComponentInfo
    usage={"import { SearchInput } from \"@orbit-ui/react-components\";"}
    compact
/>

<ArgsTable of={InnerSearchInput} />
