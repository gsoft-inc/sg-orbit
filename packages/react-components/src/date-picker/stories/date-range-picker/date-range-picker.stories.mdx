...
import { DEFAULT_DATES_PRESETS, DateRangePicker, PureDateRangePickerCalendar, PureDateRangePickerInput } from "@react-components/date-picker";
...
<Props
    componentsDefinitions={[
        ...
        { displayName: "DateRangePicker.Calendar", component: PureDateRangePickerCalendar },
...
The available positions are: `"top-start"`, `"top-end"`, `"bottom"`, `"bottom-start"`, `"bottom-end"`, `"right"`, `"right-start"`, `"right-end"`, `"left"`, `"left-start"`, `"left-end"`.
