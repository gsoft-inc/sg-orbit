...
import { FilePreview, InstallationReactComponents, Props, ReactComponentsLayout } from "@blocks";
...
<InstallationReactComponents componentFolder="date-picker" imports={<Imports />} />
