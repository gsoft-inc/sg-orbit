...
import { PureSingleDatePickerCalendar, PureSingleDatePickerInput, SingleDatePicker } from "@react-components/date-picker";
...
<Props
    componentsDefinitions={[
        ...
        { displayName: "SingleDatePicker.Calendar", component: PureSingleDatePickerCalendar },
...
<FilePreview filePath="/date-picker/stories/single-date-picker/components/controlled-single-date-picker">
