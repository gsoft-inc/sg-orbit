...
import { PureTextArea, TextArea } from "@react-components/text-area";
...
A few [API functions are available for a text area component](https://developer.mozilla.org/en-US/docs/Web/API/HTMLTextAreaElement#Methods). To use an API, first get a [ref](https://reactjs.org/docs/refs-and-the-dom.html) on the text input component, then call the API function.
