...
<Preview>
    <Story name="value">
        <DateRangeInput defaultStartDate={new Date(1970, 0, 5)} defaultEndDate={new Date(2021, 0, 5)} placeholder="dd/mm/yyyy" />
    </Story>
</Preview>
...
<Preview>
    <Story name="fluid">
        <DateRangeInput fluid placeholder="dd/mm/yyyy" />
    </Story>
</Preview>
...
<ArgsTable of={InnerDateRangeInput} />
