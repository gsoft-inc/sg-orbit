...
import { Fieldset, Form, InnerFieldset, InnerForm } from "@react-components/form";
...
<Preview>
    <Story name="inline layout grid">
        <Form fluid>
            <Grid templateColumns={{ md: "1fr", lg: repeat(3, "1fr") }}>
                <Field>
                    <Label required>First name</Label>
                    <TextInput />
                </Field>
            ...
            <Grid templateColumns={{ md: "1fr", lg: ["2fr", "1fr", "1fr"] }}>
                <Field>
                    <Label>City</Label>
                    <TextInput />
                </Field>
