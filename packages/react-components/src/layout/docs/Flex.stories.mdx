...
<Preview>
    <Story name="horizontal">
        <Flex direction="row" gap={2}>
            <Div backgroundColor="primary-5" width={9} height={9} />
            <Div backgroundColor="beetle-5" width={9} height={9} />
            <Div backgroundColor="botanic-5" width={9} height={9} />
        </Flex>
    </Story>
</Preview>
...
<Preview scope={{ ApricotTheme }}>
    <Story name="wrap">
        <Flex wrap="wrap" gap={1} width="16">
            {ApricotTheme.colors.common.primary.map(x => <Div backgroundColor={x} width={6} height={6} key={x} />)}
            {ApricotTheme.colors.common.beetle.map(x => <Div backgroundColor={x} width={6} height={6} key={x} />)}
            {ApricotTheme.colors.common.botanic.map(x => <Div backgroundColor={x} width={6} height={6} key={x} />)}
        </Flex>
    </Story>
</Preview>
