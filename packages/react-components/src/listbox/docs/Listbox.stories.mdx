...
import { LargeAvatar, SmallAvatar } from "./Avatar.jsx"
...
<Preview scope={{ SmallAvatar }}>
    <Story name="item avatar">
        <Listbox aria-label="Planets">
            <Item key="earth">
                <SmallAvatar slot="avatar">ER</SmallAvatar>
                <Text>Earth</Text>
            </Item>
            <Item key="jupiter">
                <SmallAvatar slot="avatar">JU</SmallAvatar>
                <Text>Jupiter</Text>
            </Item>
            <Item key="mars">
                <SmallAvatar slot="avatar">MA</SmallAvatar>
                <Text>Mars</Text>
            </Item>
        </Listbox>
    </Story>
...
A can be paired with an [icon](?path=/docs/icon-gallery--page).
...
A can also be paired with an avatar.

<Preview scope={{ LargeAvatar }}>
    <Story name="item description + avatar">
        <Listbox aria-label="Planets">
            <Item key="earth">
                <LargeAvatar slot="avatar">ER</LargeAvatar>
                <Text>Earth</Text>
                <Text slot="description">Home sweet home!</Text>
            </Item>
            <Item key="jupiter">
