...
export function as<A extends JSXElementConstructor<{ as?: ElementType }>, B extends keyof JSX.IntrinsicElements | JSXElementConstructor<any>>(component: A, asProp: B) {
