...
const Props: PropDefinition[] = [
    ...
    { name: "border bottom", key: "borderBottom", values: Object.keys(BorderBottomClasses) },
    { name: "border radius", key: "borderRadius", values: Object.keys(BorderRadiusClasses) },
    { name: "border left", key: "borderLeft", values: Object.keys(BorderLeftClasses) },
    { name: "border right", key: "borderRight", values: Object.keys(BorderRightClasses) },
    { name: "border top", key: "borderTop", values: Object.keys(BorderTopClasses) },
