...
const Props: PropDefinition[] = [
    ...
    { name: "appearance", key: "appearance", values: ["none"] },
    { name: "aspect ratio", key: "aspectRatio", values: ["1/1"] },
    { name: "backface visibility", key: "backfaceVisibility", values: ["visible"] },
    ...
    { name: "background origin", key: "backgroundOrigin", values: ["content-box"] },
    ...
    { name: "color scheme", key: "colorScheme", values: ["dark"] },
    { name: "column count", key: "columnCount", values: [1] },
    { name: "column gap", key: "columnGap", values: [0, ...OrbitSpacingScale] },
    { name: "column width", key: "columnWidth", values: ["100px"] },
    { name: "contain", key: "contain", values: ["strict"] },
    ...
    { name: "font feature settings", key: "fontFeatureSettings", values: ["smcp"] },
    { name: "font kerning", key: "fontKerning", values: ["normal"] },
    { name: "font size", key: "fontSize", values: Object.keys(FontSizeClasses) },
    { name: "font variant", key: "fontVariant", values: ["small-caps"] },
    { name: "font variations settings", key: "fontVariationsSettings", values: ["'XHGT' 0.7"] },
