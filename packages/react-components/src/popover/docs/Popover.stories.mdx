...
<ComponentInfo
    usage={"import { PopoverTrigger, Popover, PopoverTriggerContext, Header, Content } from \"@orbit-ui/react-components\""}
...
A popper can contain a single button or a group of button.
