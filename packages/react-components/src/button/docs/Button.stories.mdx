...
*Non standard* right [icons](?path=/docs/icon-gallery--page) can be provided to handle special cases. However, think twice before adding right icons, left icons should be your go to.
