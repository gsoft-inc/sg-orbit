...
<Preview>
    <Story name="disabled">
        <Button disabled variant="secondary">Cutoff</Button>
    </Story>
</Preview>
...
A button can use a different style.
...
<Preview>
    <Story name="shape">
        <Inline>
            <Button shape="circular" variant="secondary">Aa</Button>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="icon button">
        <Inline alignY="center">
            <IconButton size="sm" variant="secondary" aria-label="Add"><AddIcon /></IconButton>
...
<Preview>
    <Story name="toggle button">
        <Inline>
            <ToggleButton variant="secondary" shape="circular">On</ToggleButton>
