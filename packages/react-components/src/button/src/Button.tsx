...
import { InteractionStatesProps, InternalProps, OmitInternalProps, as, createSizeAdapter, cssModule, mergeProps, omitProps, slot, useSlots, useStyleProps } from "../../shared";
