...
import { InteractionStatesProps, InternalProps, OmitInternalProps, createSizeAdapter, cssModule, mergeProps, omitProps, slot, useSlots, useStyleProps } from "../../shared";
