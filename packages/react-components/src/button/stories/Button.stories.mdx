import { AddIcon, EditIcon, IconGroup, InfoIcon, LightbulbIcon, WarningIcon } from "@react-components/icons";
import { Badge } from "@react-components/badge";
import { Button, IconButton, InnerButton, InnerIconButton } from "@react-components/button";
...
<Preview>
    <Story name="icon">
        <Stack>
            ...
            <Button iconLeft={<IconGroup><WarningIcon /><InfoIcon /></IconGroup>}>Cutoff</Button>
