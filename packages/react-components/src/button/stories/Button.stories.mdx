...
This component follow WAI-ARIA [design pattern for button](https://www.w3.org/TR/wai-aria-practices-1.1/#button).
...
<Preview>
    <Story name="icon">
        <Inline>
            ...
            <Button icon={<IconGroup><LightbulbIcon /><LightbulbIcon /></IconGroup>}>Cutoff</Button>
        </Inline>
    </Story>
</Preview>
...
A button can contain a [counter](?path=/story/components-counter--default-story).

<Preview>
    <Story name="counter">
        <Inline>
            <Button counter={<Counter>6</Counter>}>Cutoff</Button>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="icon button">
        <Inline align="end">
            <IconButton shape="circular" size="mini"><AddIcon /></IconButton>
            <IconButton shape="circular" size="tiny"><AddIcon /></IconButton>
            <IconButton shape="circular" size="small"><AddIcon /></IconButton>
            <IconButton shape="circular"><AddIcon /></IconButton>
            <IconButton shape="circular" size="large"><AddIcon /></IconButton>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="toggle icon button">
        <ToggleIconButton variant="outline" shape="circular">
            <CheckIcon />
        </ToggleIconButton>
    </Story>
</Preview>
