...
<Props
    componentsDefinitions={[
        ...
        { displayName: "CloseButton", component: InnerCrossButton }
    ]}
/>

## Accessibility

Follow [WAI-ARIA design pattern for button](https://www.w3.org/TR/wai-aria-practices/#button).
...
A toggle button can update is content with render prop function based on the `isChecked` value.
...
An icon button adapted to handle close functionnality in feedback and overlay components like [Alert](?path=/docs/feedback-alert).
