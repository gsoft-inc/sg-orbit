...
<Preview>
    <Story name="icon button">
        <Inline align="end">
            <IconButton shape="circular" size="mini" aria-label="Add"><AddIcon /></IconButton>
            <IconButton shape="circular" size="tiny" aria-label="Add"><AddIcon /></IconButton>
            <IconButton shape="circular" size="small" aria-label="Add"><AddIcon /></IconButton>
            <IconButton shape="circular" aria-label="Add"><AddIcon /></IconButton>
            <IconButton shape="circular" size="large" aria-label="Add"><AddIcon /></IconButton>
        </Inline>
    </Story>
</Preview>
