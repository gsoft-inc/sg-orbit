import { AddIcon, CheckIcon, EditIcon, IconGroup, InfoIcon, LightbulbIcon, NotificationIcon, NotificationOffIcon, WarningIcon } from "@react-components/icons";
...
import { logToggleChange } from "./utils";
...
<Preview>
    <Story name="toggle button">
        <Stack>
            <ToggleButton value="isActive" variant="outline" color="primary" size="mini" onChange={logToggleChange}>On</ToggleButton>
            <ToggleButton value="isActive" variant="outline" color="primary" size="tiny" onChange={logToggleChange}>On</ToggleButton>
            <ToggleButton value="isActive" variant="outline" color="primary" size="small" onChange={logToggleChange}>On</ToggleButton>
            <ToggleButton value="isActive" variant="outline" color="primary" onChange={logToggleChange}>On</ToggleButton>
            <ToggleButton value="isActive" variant="outline" color="primary" size="large" onChange={logToggleChange}>On</ToggleButton>
        </Stack>
    </Story>
</Preview>
...
<Preview>
    <Story name="toggle icon button">
        <Stack>
            <ToggleIconButton value="isActive" variant="outline" color="primary" circular size="mini" onChange={logToggleChange}>
                <CheckIcon />
            </ToggleIconButton>
            <ToggleIconButton value="isActive" variant="outline" color="primary" circular size="tiny" onChange={logToggleChange}>
                <CheckIcon />
            </ToggleIconButton>
            <ToggleIconButton value="isActive" variant="outline" color="primary" circular size="small" onChange={logToggleChange}>
                <CheckIcon />
            </ToggleIconButton>
            <ToggleIconButton value="isActive" variant="outline" color="primary" circular onChange={logToggleChange}>
                <CheckIcon />
            </ToggleIconButton>
            <ToggleIconButton value="isActive" variant="outline" color="primary" circular size="large" onChange={logToggleChange}>
                <CheckIcon />
            </ToggleIconButton>
        </Stack>
    </Story>
...
<Preview>
    <Story name="toggle button group multiple">
        <ToggleButtonGroup onChange={logToggleChange}>
