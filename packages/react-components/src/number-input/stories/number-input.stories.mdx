...
A few [API functions are available for a number input component](https://developer.mozilla.org/en-US/docs/Web/API/HTMLInputElement#Methods). To use an API, first get a [ref](https://reactjs.org/docs/refs-and-the-dom.html) on the number input component, then call the API function.
