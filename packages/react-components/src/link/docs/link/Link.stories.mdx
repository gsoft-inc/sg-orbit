...
A link accept any elements as children. Unlike a [text link](?path=/docs/links-textlink) or an [icon link](?path=/docs/links-iconlink), a link component will have a more subtle appearance.
