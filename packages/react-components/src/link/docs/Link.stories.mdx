...
import { IconLink, InnerIconLink, InnerLink, InnerTextLink, Link, TextLink, TextLinkAsButton } from "@react-components/link";
...
<ComponentInfo
    usage={"import { TextLink, IconLink, Link, TextLinkAsButton } from \"@orbit-ui/react-components\";"}
    ariaPath="#link"
...
A link can behave like a button by the `TextLinkAsButton` component.
