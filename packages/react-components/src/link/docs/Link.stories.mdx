...
Link component accepting text content.
...
Link component accepting a single icon.
...
Link component accepting any generic content like an image or a box.
...
Placeholder component for text.
