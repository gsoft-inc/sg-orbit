...
import { IconLink, IconLinkAsButton, InnerIconLink, InnerLink, InnerTextLink, Link, TextLink, TextLinkAsButton } from "@react-components/link";
...
<ComponentInfo
    usage={"import { TextLink, IconLink, Link, TextLinkAsButton, IconLinkAsButton } from \"@orbit-ui/react-components\";"}
    ariaPath="#link"
...
<ComponentInfo
    usage={"import { TextLinkAsButton } from \"@orbit-ui/react-components\";"}
    compact
/>
...
<ComponentInfo
    usage={"import { IconLinkAsButton } from \"@orbit-ui/react-components\";"}
    compact
/>
