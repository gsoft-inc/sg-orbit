...
Some type of triggers requires extra work to be fully integrated with a popper. Adapters are meant to abstract this complexity. Use them whenever you can, they will save you time and simplify your code.
