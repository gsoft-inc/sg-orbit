import { AutoControlledPopper, InnerAutoControlledPopper, InnerPopper, Popper } from "@react-components/popper"
...
<Preview>
    <Story name="disabled">
        <AutoControlledPopper trigger={<Button disabled>Toggle</Button>}>
            <Popper>
                <div className="bg-primary-300 white pa2">A comet is an icy, small Solar System body.</div>
            </Popper>
        </AutoControlledPopper>
...
<Preview>
    <Story name="fluid">
        <AutoControlledPopper trigger={<Button fluid>Toggle</Button>}>
            <Popper fluid>
                <div className="bg-primary-300 white pa2">A comet is an icy, small Solar System body.</div>
            </Popper>
        </AutoControlledPopper>
