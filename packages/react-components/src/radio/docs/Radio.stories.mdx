...
<FileCanvas filePath="/radio/docs/ValueSelectedValidation">
...
<FileCanvas filePath="/radio/docs/CustomGroup">
    <CustomGroup />
</FileCanvas>
...
<FileCanvas filePath="/radio/docs/ControlledRadioGroup">
...
<Story
    ...
    parameters={paramsBuilder()
        .component(InnerRadio)
        .excludeFromDocs()
        .build()}
>
    {args =>
        <InnerRadio value="mars" {...args} />
    }
</Story>
