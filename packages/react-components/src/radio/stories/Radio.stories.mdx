...
A radio group can have a label.

<Preview>
    <Story name="label">
        <RadioGroup label="Your favorite planet">
            <Radio value="mars">Mars</Radio>
            <Radio value="jupiter">Jupiter</Radio>
            <Radio value="pluto">Pluto</Radio>
        </RadioGroup>
...
<Preview>
    <Story name="counter">
        <RadioGroup>
            <Radio counter={<Counter>6</Counter>} value="mars">Mars</Radio>
            <Radio value="jupiter">Jupiter</Radio>
            <Radio counter={<Counter variant="divider">6</Counter>} value="pluto">Pluto</Radio>
        </RadioGroup>
    </Story>
</Preview>
...
<Preview>
    <Story name="reverse">
        <RadioGroup>
            <Radio reverse icon={<LightbulbIcon />} counter={<Counter>6</Counter>} value="mars">Mars</Radio>
            <Radio reverse value="jupiter">Jupiter</Radio>
            <Radio reverse value="pluto" counter={<Counter variant="divider">6</Counter>}>Pluto</Radio>
        </RadioGroup>
    </Story>
</Preview>
