...
import { IconList, LightbulbIcon } from "@react-components/icons";
...
<Preview>
    <Story name="size radio">
        <Inline align="end">
            <Radio size="sm" value="mars">Mars</Radio>
            <Radio value="mars">Mars</Radio>
            <Radio size="lg" value="mars">Mars</Radio>
        </Inline>
    </Story>
</Preview>
...
A radio can update is content with a render prop function providing an `isChecked` value:
