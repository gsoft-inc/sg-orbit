...
import { InnerMenu, InnerMenuArrow, InnerMenuTrigger, Menu, MenuArrow, MenuTrigger } from "@react-components/menu";
...
<ComponentInfo
    usage={"import { MenuTrigger, Menu, Item, Section, Divider, MenuArrow, MenuTriggerContext, useMenuTriggerContext } from \"@orbit-ui/react-components\""}
    ariaPath="#menu"
...
You can use a [menu arrow](?path=/docs/menu-arrow--context) component to hint that activating the button will display additional content.
