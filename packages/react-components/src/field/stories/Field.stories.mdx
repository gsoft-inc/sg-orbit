...
When combined with a Form, a field commponent follows the [WAI specifications for forms](https://www.w3.org/WAI/tutorials/forms/).

## Slots

A field component support the following [slots](?path=/docs/getting-started-slots--page): `"label"`, `"input"`, `"message"`.
...
<Preview>
    <Story name="input">
        <Field>
            ...
            <HelpMessage>Your space id is a 9-digit number on the top right corner of your membership card.</HelpMessage>
        </Field>
    </Story>
</Preview>
