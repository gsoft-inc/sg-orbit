...
import { HelpIcon, IconList, LightbulbIcon, MagnifierIcon, NotificationIcon } from "@components/icons";
import { HiddenSelect, InnerSelect, Select } from "@components/select";
...
<ComponentInfo
    usage={"import { Select, Item, Section, HiddenSelect, useSelect } from \"@orbit-ui/components\";"}
    ariaPath="#listbox"
...
<ComponentInfo
    usage={"import { Select } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { Item } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { Section } from \"@orbit-ui/components\";"}
    compact
/>
...
<ComponentInfo
    usage={"import { HiddenSelect } from \"@orbit-ui/components\";"}
    inherits={[HiddenSelect.defaultElement, "styled-component"]}
    compact
/>
