...
test("right arrow keypress select the next radio", async () => {
    ...
    await fireEvent.keyDown(getInput(getByTestId("radio-1")), { key: Keys.arrowRight });
...
test("left arrow keypress select the next radio", async () => {
    ...
    await fireEvent.keyDown(getInput(getByTestId("radio-1")), { key: Keys.arrowLeft });
...
test("down arrow keypress select the next radio", async () => {
    ...
    await fireEvent.keyDown(getInput(getByTestId("radio-1")), { key: Keys.arrowDown });
...
test("up arrow keypress select the next radio", async () => {
    ...
    await fireEvent.keyDown(getInput(getByTestId("radio-1")), { key: Keys.arrowUp });
...
test("when a radio value is not provided, the value is autogenerated", async () => {
    ...
    await userEvent.click(getInput(getByTestId("radio-2")));
...
test("call onChange when a radio is selected", async () => {
    ...
    await userEvent.click(getInput(getByTestId("radio-1")));
...
describe("with toggle buttons", () => {
    test("a toggled button have aria-checked set to \"true\"", async () => {
        ...
        await userEvent.click(getByTestId("button-1"));
