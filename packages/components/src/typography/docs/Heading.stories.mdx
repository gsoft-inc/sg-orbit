...
You can alter the size of an heading component by specifying a `size` prop. The available size match Orbit [typographic headlines](?path=/docs/typography--page#headlines).
