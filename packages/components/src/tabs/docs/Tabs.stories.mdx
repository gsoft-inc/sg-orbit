...
<ComponentInfo
    usage={"import { Tabs, Item, Header, Content, TabsContext, useTabsContext } from \"@orbit-ui/components\";"}
    ariaPath="#tabpanel"
...
<ComponentInfo
    usage={"import { Tabs } from \"@orbit-ui/components\";"}
    compact
/>
...
<ComponentInfo
    usage={"import { Tab } from \"@orbit-ui/components\";"}
    slots={["icon", "text", "lozenge"]}
    compact
/>
...
<ComponentInfo
    usage={"import { TabPanel } from \"@orbit-ui/components\";"}
    compact
/>
