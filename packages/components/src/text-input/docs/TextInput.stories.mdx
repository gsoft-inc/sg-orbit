...
<ComponentInfo
    usage={"import { TextInput, SearchInput, PasswordInput } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { TextInput } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { SearchInput } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { PasswordInput } from \"@orbit-ui/components\";"}
