...
import { HelpIcon, IconList, LightbulbIcon, NotificationIcon, VerticalDotsIcon } from "@components/icons";
...
<ComponentInfo
    usage={"import { MenuTrigger, Menu, Item, Section, Divider, MenuTriggerContext, useMenuTriggerContext } from \"@orbit-ui/components\";"}
    ariaPath="#menu"
...
<ComponentInfo
    usage={"import { MenuTrigger } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { Menu } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { MenuItem } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { MenuSection } from \"@orbit-ui/components\";"}
