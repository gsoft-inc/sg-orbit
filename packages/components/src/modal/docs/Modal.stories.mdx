...
<ComponentInfo
    usage={"import { Modal, ModalTrigger, Heading, Header, Content, Footer, ModalTriggerContext, useModalTriggerContext } from \"@orbit-ui/components\";"}
...
A modal can have a side banner [image](?path=/story/chromatic-image--default):
...
<ComponentInfo
    usage={"import { ModalTrigger } from \"@orbit-ui/components\";"}
    compact
/>
...
<ComponentInfo
    usage={"import { Modal } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { Footer } from \"@orbit-ui/components\";"}
    compact
/>
