...
- To inform the user of a non-critical situation.
...
### Message vs Modal vs Alert

- If the user flow has to be interrupted, use either a [modal](?path=/docs/modal--default-story) or an [alert](?path=/docs/alert--default-story).
