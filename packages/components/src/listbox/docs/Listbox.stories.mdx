...
import { HelpIcon, IconList, LightbulbIcon, NotificationIcon } from "@components/icons";
...
<ComponentInfo
    usage={"import { Listbox, Item, Section, ListboxContext, useListboxContext } from \"@orbit-ui/components\";"}
    ariaPath="#listbox"
...
<ComponentInfo
    usage={"import { Listbox } from \"@orbit-ui/components\";"}
    compact
/>
...
<ComponentInfo
    usage={"import { ListboxOption } from \"@orbit-ui/components\";"}
    slots={["icon", "avatar", "text", "description", "end-icon"]}
    compact
/>
...
<ComponentInfo
    usage={"import { ListboxSection } from \"@orbit-ui/components\";"}
    compact
/>
