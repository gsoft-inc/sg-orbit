...
import { HelpMajorIcon, IconList, LightbulbMajorIcon, NotificationMajorIcon } from "@components/icons";
...
<ComponentInfo
    usage={"import { Listbox } from \"@sharegate/orbit-ui\";"}
...
<ComponentInfo
    usage={"import { ListboxOption } from \"@sharegate/orbit-ui\";"}
    slots={["icon", "avatar", "text", "description", "end-icon"]}
...
<ComponentInfo
    usage={"import { ListboxSection } from \"@sharegate/orbit-ui\";"}
