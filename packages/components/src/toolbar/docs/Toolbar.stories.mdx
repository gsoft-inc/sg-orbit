...
<Preview>
    <Story name="default">
        <Toolbar>
            ...
            <CheckboxGroup>
                <ToggleButton tone="basic" variant="outline" value="round-trip">Round trip</ToggleButton>
                <ToggleButton tone="basic" variant="outline" value="one-way">One way</ToggleButton>
            </CheckboxGroup>
        </Toolbar>
    </Story>
</Preview>
