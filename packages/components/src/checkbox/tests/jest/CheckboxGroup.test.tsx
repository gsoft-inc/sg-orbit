...
test("when a checkbox value is not provided, the value is autogenerated", async () => {
    ...
    await userEvent.click(getInput(getAllByTestId("checkbox")[0]));

    await userEvent.click(getInput(getAllByTestId("checkbox")[1]));

    await userEvent.click(getInput(getAllByTestId("checkbox")[2]));
