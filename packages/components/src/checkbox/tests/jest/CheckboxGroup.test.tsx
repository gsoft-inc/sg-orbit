...
test("when a checkbox value is not provided, the value is autogenerated", async () => {
    ...
    act(() => {
        userEvent.click(getInput(screen.getAllByTestId("checkbox")[0]));
    });

    act(() => {
        userEvent.click(getInput(screen.getAllByTestId("checkbox")[1]));
    });

    act(() => {
        userEvent.click(getInput(screen.getAllByTestId("checkbox")[2]));
    });
