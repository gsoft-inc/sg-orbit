...
<ComponentInfo
    usage={"import { Checkbox, CheckboxGroup } from \"@orbit-ui/components\";"}
    ariaPath="#checkbox"
...
<ComponentInfo
    usage={"import { Checkbox } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { CheckboxGroup } from \"@orbit-ui/components\";"}
