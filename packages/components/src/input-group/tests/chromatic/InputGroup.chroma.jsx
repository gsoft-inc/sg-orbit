...
stories()
    ...
    .add("button addon", () =>
        <Stack>
            <Inline>
                <InputGroup>
                    <Button color="basic" variant="outline">Trigger</Button>
                    <TextInput aria-label="Duration" />
                </InputGroup>
                <InputGroup>
                    <TextInput aria-label="Duration" />
                    <Button color="basic" variant="outline">Copy</Button>
                </InputGroup>
                <InputGroup>
                    <Button color="basic" variant="outline">Trigger</Button>
                    <TextInput aria-label="Duration" />
            ...
            <Inline>
                <InputGroup>
                    <TextInput aria-label="Duration" />
                    <Button active color="basic" variant="outline">Copy</Button>
                </InputGroup>
                <InputGroup>
                    <TextInput aria-label="Duration" />
                    <Button focus color="basic" variant="outline">Copy</Button>
                </InputGroup>
                <InputGroup>
                    <TextInput aria-label="Duration" />
                    <Button hover color="basic" variant="outline">Copy</Button>
                </InputGroup>
            </Inline>
            <Inline>
                <InputGroup>
                    <TextInput aria-label="Duration" />
                    <Button focus hover color="basic" variant="outline">Copy</Button>
                </InputGroup>
            </Inline>
            <Inline>
                <InputGroup>
    ...
    .add("icon button addon", () =>
        <Stack>
            <Inline>
                <InputGroup>
                    <IconButton color="basic" variant="outline" aria-label="Icon"><LightbulbIcon /></IconButton>
                    <TextInput aria-label="Duration" />
                </InputGroup>
                <InputGroup>
                    <TextInput aria-label="Duration" />
            ...
            <Inline>
                <InputGroup>
                    <TextInput aria-label="Duration" />
                    <IconButton active color="basic" variant="outline" aria-label="Icon"><LightbulbIcon /></IconButton>
                </InputGroup>
                <InputGroup>
                    <TextInput aria-label="Duration" />
                    <IconButton focus color="basic" variant="outline" aria-label="Icon"><LightbulbIcon /></IconButton>
                </InputGroup>
                <InputGroup>
                    <TextInput aria-label="Duration" />
                    <IconButton hover color="basic" variant="outline" aria-label="Icon"><LightbulbIcon /></IconButton>
                </InputGroup>
            </Inline>
            <Inline>
                <InputGroup>
                    <TextInput aria-label="Duration" />
                    <IconButton focus hover color="basic" variant="outline" aria-label="Icon"><LightbulbIcon /></IconButton>
                </InputGroup>
            </Inline>
            <Inline>
                <InputGroup>
    ...
    .add("menu addon", () =>
        <Stack>
            <Inline>
                ...
                <InputGroup>
                    <MenuTrigger>
                        <IconButton color="basic" variant="outline" aria-label="Select a planet"><DisclosureArrow /></IconButton>
                        <Menu aria-label="Planets">
                            <Item key="earth">Earth</Item>
                            <Item key="mars">Mars</Item>
                            <Item key="saturn">Saturn</Item>
