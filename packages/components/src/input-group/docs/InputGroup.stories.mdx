...
<ComponentInfo
    usage={"import { InputGroup, TextAddon, InputGroupContext, useInputGroupProps, useInputGroupAddonProps } from \"@sharegate/orbit-ui\";"}
...
<Preview>
    <Story name="menu addon">
        <InputGroup>
            ...
            <MenuTrigger>
                <IconButton aria-label="Select a galaxy" color="secondary" variant="outline">
                    <DisclosureArrow />
                </IconButton>
...
<ComponentInfo
    usage={"import { InputGroup } from \"@sharegate/orbit-ui\";"}
...
<ComponentInfo
    usage={"import { TextAddon } from \"@sharegate/orbit-ui\";"}
