...
<ComponentInfo
    usage={"import { Flex, Inline, Stack } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { Flex } from \"@orbit-ui/components\";"}
    compact
/>
...
<ComponentInfo
    usage={"import { Inline } from \"@orbit-ui/components\";"}
    compact
/>
...
<ComponentInfo
    usage={"import { Stack } from \"@orbit-ui/components\";"}
    compact
/>
