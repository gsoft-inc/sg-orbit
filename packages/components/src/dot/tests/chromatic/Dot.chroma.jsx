...
export const Default = () => <Dot color="alias-hard-break" />;

export const Label = () => <Dot color="alias-hard-break">Habitable</Dot>;

export const Color = () => <Stack>
