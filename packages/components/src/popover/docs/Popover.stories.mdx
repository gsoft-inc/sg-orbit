...
A popover is not meant to be used as a [tooltip](?path=/docs/tooltip--default-story). If you need a component which behave like a tooltip, use the tooltip component instead.
