...
<ComponentInfo
    usage={"import { PopoverTrigger, Popover, Heading, Content, Footer, usePopoverTriggerContext } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { PopoverTrigger } from \"@orbit-ui/components\";"}
    compact
/>
...
<ComponentInfo
    usage={"import { Popover } from \"@orbit-ui/components\";"}
