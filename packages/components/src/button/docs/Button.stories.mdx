...
<Preview>
    <Story name="toggle button">
        <Inline>
            <ToggleButton variant="outline" tone="basic">On</ToggleButton>
...
<Preview>
    <Story name="toggle button group">
        <RadioGroup gap={2} orientation="horizontal">
            ...
            <ToggleButton value="1" variant="outline" tone="basic">1</ToggleButton>
            <ToggleButton value="2" variant="outline" tone="basic">2</ToggleButton>
            <ToggleButton value="3" variant="outline" tone="basic">3</ToggleButton>
            <ToggleButton value="4+" variant="outline" tone="basic">4+</ToggleButton>
        </RadioGroup>
    </Story>
</Preview>
