...
<Preview>
    <Story name="size">
        <Inline alignY="center">
            <Button size="sm" variant="outline" color="secondary">Cutoff</Button>
            <Button variant="outline" color="secondary">Cutoff</Button>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="loading">
        <Button loading variant="outline" color="secondary">Loading</Button>
    </Story>
</Preview>
...
<Preview>
    <Story name="fluid">
        <Button fluid variant="outline" color="secondary">
            <LightbulbIcon />
...
A button can use a different base color.

<Preview>
    <Story name="color">
        <Inline>
            <Button color="primary">Primary</Button>
            <Button color="negative">Danger</Button>
            <Button variant="outline" color="primary">Primary</Button>
            <Button variant="outline" color="secondary">Primary</Button>
            <Button variant="outline" color="negative">Danger</Button>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="ghost">
        <Inline>
            ...
            <Button color="negative" variant="ghost">Delete</Button>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="shape">
        <Inline>
            <Button shape="circular" variant="outline" color="secondary">Aa</Button>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="as anchor">
        <ButtonAsLink href="https://sharegate.com" target="_blank" variant="outline" color="secondary">Cutoff</ButtonAsLink>
    </Story>
</Preview>
...
<Preview>
    <Story name="icon button">
        <Inline alignY="center">
            <IconButton size="sm" variant="outline" color="secondary" aria-label="Add"><AddIcon /></IconButton>
            <IconButton variant="outline" color="secondary" aria-label="Add"><AddIcon /></IconButton>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="button group">
        <ButtonGroup>
            ...
            <Button variant="outline" color="secondary">Rate Now</Button>
        </ButtonGroup>
    </Story>
</Preview>
...
<Preview>
    <Story name="toggle button">
        <Inline>
            <ToggleButton variant="outline" color="secondary" shape="circular">On</ToggleButton>
            <ToggleButton variant="outline" color="secondary">
                <LightbulbIcon />
                <Text>Cutoff</Text>
            </ToggleButton>
        </Inline>
...
<Preview>
    <Story name="toggle icon button">
        <ToggleIconButton variant="outline" color="secondary" aria-label="Activate">
            <CheckIcon />
        </ToggleIconButton>
    </Story>
</Preview>
...
<Preview>
    <Story name="toggle button group">
        <RadioGroup gap={2} orientation="horizontal">
            <ToggleButton value="none" variant="outline" color="secondary">None</ToggleButton>
            <ToggleButton value="1" variant="outline" color="secondary" shape="circular">1</ToggleButton>
            <ToggleButton value="2" variant="outline" color="secondary" shape="circular">2</ToggleButton>
            <ToggleButton value="3" variant="outline" color="secondary" shape="circular">3</ToggleButton>
            <ToggleButton value="4+" variant="outline" color="secondary" shape="circular">4+</ToggleButton>
        </RadioGroup>
    </Story>
</Preview>
