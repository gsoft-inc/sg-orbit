...
<Preview>
    <Story name="icon">
        <Button variant="outline" color="basic">
            <LightbulbIcon />
            <Text>Cutoff</Text>
        </Button>
    </Story>
...
<Preview>
    <Story name="size">
        <Inline alignY="center">
            <Button size="sm" variant="outline" color="basic">Cutoff</Button>
            <Button variant="outline" color="basic">Cutoff</Button>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="loading">
        <Button loading variant="outline" color="basic">Loading</Button>
    </Story>
</Preview>
...
<Preview>
    <Story name="fluid">
        <Button fluid variant="outline" color="basic">
            <LightbulbIcon />
...
<Preview>
    <Story name="color">
        <Inline>
            ...
            <Button variant="outline" color="basic">Basic</Button>
...
<Preview>
    <Story name="ghost">
        <Inline>
            <Button color="accent" variant="ghost">Accent</Button>
            <Button color="basic" variant="ghost">Basic</Button>
...
<Preview>
    <Story name="shape">
        <Inline>
            <Button shape="circular" variant="outline" color="basic">Aa</Button>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="as anchor">
        <ButtonAsLink href="https://sharegate.com" target="_blank" variant="outline" color="basic">Cutoff</ButtonAsLink>
    </Story>
</Preview>
...
<Preview>
    <Story name="icon button">
        <Inline alignY="center">
            <IconButton size="sm" variant="outline" color="basic" aria-label="Add"><AddIcon /></IconButton>
            <IconButton variant="outline" color="basic" aria-label="Add"><AddIcon /></IconButton>
        </Inline>
    </Story>
</Preview>
...
<Preview>
    <Story name="button group">
        <ButtonGroup>
            <Button variant="outline" color="basic">No, thanks</Button>
            <Button variant="outline" color="basic">Remind me later</Button>
            <Button variant="outline" color="basic">Rate Now</Button>
        </ButtonGroup>
    </Story>
</Preview>
...
<Preview>
    <Story name="toggle button">
        <Inline>
            <ToggleButton variant="outline" color="basic" shape="circular">On</ToggleButton>
            <ToggleButton variant="outline" color="basic">
                <LightbulbIcon />
                <Text>Cutoff</Text>
            </ToggleButton>
        </Inline>
...
<Preview>
    <Story name="toggle icon button">
        <ToggleIconButton variant="outline" color="basic" aria-label="Activate">
            <CheckIcon />
        </ToggleIconButton>
    </Story>
</Preview>
...
<Preview>
    <Story name="toggle button group">
        <RadioGroup gap={2} orientation="horizontal">
            <ToggleButton value="none" variant="outline" color="basic">None</ToggleButton>
            <ToggleButton value="1" variant="outline" color="basic" shape="circular">1</ToggleButton>
            <ToggleButton value="2" variant="outline" color="basic" shape="circular">2</ToggleButton>
            <ToggleButton value="3" variant="outline" color="basic" shape="circular">3</ToggleButton>
            <ToggleButton value="4+" variant="outline" color="basic" shape="circular">4+</ToggleButton>
        </RadioGroup>
    </Story>
</Preview>
