...
<ComponentInfo
    usage={"import { Accordion, Item, Header, Content, AccordionContext, useAccordionContext } from \"@orbit-ui/components\";"}
    ariaPath="#accordion"
...
<ComponentInfo
    usage={"import { Accordion } from \"@orbit-ui/components\";"}
...
<ComponentInfo
    usage={"import { AccordionHeader } from \"@orbit-ui/components\";"}
    slots={["icon", "text"]}
...
<ComponentInfo
    usage={"import { AccordionPanel } from \"@orbit-ui/components\";"}
