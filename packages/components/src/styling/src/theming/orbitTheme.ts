...
export interface ColorAliases {
    ...
    "bg-alias-basic-faint": AliasValue;
    "bg-alias-basic-faint-hover": AliasValue;
    "bg-alias-basic-faint-active": AliasValue;
    ...
    "bg-alias-accent-faint-hover": AliasValue;
    "bg-alias-accent-faint-active": AliasValue;
