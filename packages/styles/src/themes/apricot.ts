...
export const ApricotTheme: ApricotTheme = {
    ...
    boxShadows: {
        common: {
            "skim": "$box-shadows-1",
            "lifted": "$box-shadows-2",
            "raised": "$box-shadows-3",
            "floating": "$box-shadows-4",
        },
        light: [`
    ...
    colors: {
        ...
        light: {
            ...
            "bg-3": "$cloud-1",
            "bg-4": "$neutral-2",
            "bg-4-hover": "$neutral-4",
            "bg-4-active": "$neutral-7",
            "bg-5": "$marine-6",
            "bg-5-hover": "$marine-8",
            "bg-5-active": "$marine-10",
            "bg-6": "$neutral-1",
            "bg-6-hover": "$neutral-2",
            "bg-6-active": "$neutral-3",
            "bg-primary-1": "$primary-5",
            "bg-primary-1-hover": "$primary-8",
            "bg-primary-1-active": "$primary-10",
            "bg-primary-1-focus": "$primary-1",
            "bg-primary-2": "$primary-1",
            "bg-negative-1": "$beetle-5",
            "bg-negative-1-hover": "$beetle-8",
            "bg-negative-1-active": "$beetle-10",
            "bg-negative-2": "$beetle-1",
            "bg-warning-1": "$sunray-1",
            "bg-warning-1-hover": "$sunray-8",
            "bg-warning-1-active": "$sunray-10",
            "bg-warning-2": "$sunray-1",
            "bg-positive-1": "$botanic-5",
            "bg-positive-1-hover": "$botanic-8",
            "bg-positive-1-active": "$botanic-10",
            "bg-positive-2": "$botanic-1",
            "bg-info-1": "$marine-1",
            "bg-info-1-hover": "$marine-2",
            "bg-info-active": "$marine-4",
            /* Border */
            "b-1": "$cloud-2",
            "b-1-hover": "$cloud-4",
            "b-1-active": "$cloud-6",
            ...
            "b-3": "$neutral-6",
            "b-3-hover": "$neutral-8",
            "b-3-active": "$neutral-10",
            "b-4": "$marine-6",
            "b-4-hover": "$marine-8",
            "b-primary-1": "$primary-5",
            "b-primary-1-hover": "$primary-8",
            "b-primary-1-active": "$primary-10",
            "b-primary-1-translucent": "hsla(172, 65%, 48%, 50%)",
            "b-negative-1": "$beetle-6",
            "b-negative-1-hover": "$beetle-8",
            "b-negative-1-active": "$beetle-10",
            "b-negative-1-translucent": "hsla(348, 98%, 53%, 50%)",
            "b-negative-2": "$beetle-3",
            "b-warning-1": "$sunray-6",
            "b-warning-1-hover": "$sunray-8",
            "b-warning-1-active": "$sunray-10",
            "b-positive-1": "$botanic-6",
            "b-positive-1-hover": "$botanic-8",
            "b-positive-1-active": "$botanic-10",
            /* Icon */
            "icon-1": "$marine-10",
            "icon-2": "$marine-6",
        ...
        dark: {
            ...
            "bg-3": "$cloud-10",
            "bg-4": "$neutral-dark-9",
            "bg-4-hover": "$neutral-dark-4",
            "bg-4-active": "$neutral-dark-2",
            "bg-5": "$marine-7",
            "bg-5-hover": "$marine-6",
            "bg-5-active": "$marine-5",
            "bg-6": "$neutral-dark-10",
            "bg-6-hover": "$neutral-dark-9",
            "bg-6-active": "$neutral-dark-8",
            "bg-primary-1": "$primary-8",
            "bg-primary-1-hover": "$primary-6",
            "bg-primary-1-active": "$primary-5",
            "bg-primary-1-focus": "$neutral-dark-9",
            "bg-primary-2": "$neutral-dark-9",
            "bg-negative-1": "$beetle-8",
            "bg-negative-1-hover": "$beetle-6",
            "bg-negative-1-active": "$beetle-5",
            "bg-negative-2": "$beetle-10",
            "bg-warning-1": "$sunray-8",
            "bg-warning-1-hover": "$sunray-6",
            "bg-warning-1-active": "$sunray-5",
            "bg-warning-2": "$sunray-10",
            "bg-positive-1": "$botanic-8",
            "bg-positive-1-hover": "$botanic-6",
            "bg-positive-1-active": "$botanic-5",
            "bg-positive-2": "$botanic-10",
            "bg-info-1": "$marine-7",
            "bg-info-1-hover": "$marine-5",
            "bg-info-active": "$marine-4",
            /* Border */
            "b-1": "$neutral-dark-7",
            "b-1-hover": "$neutral-dark-5",
            "b-1-active": "$neutral-dark-4",
            "b-2": "$neutral-dark-9",
            "b-3": "$neutral-dark-5",
            "b-4": "$marine-5",
            "b-4-hover": "$marine-7",
            "b-primary-1": "$primary-8",
            "b-primary-1-hover": "$primary-5",
            "b-primary-1-active": "$primary-4",
            "b-primary-1-translucent": "hsla(172, 63%, 45%, 50%)",
            "b-negative-1": "$beetle-8",
            "b-negative-1-hover": "$beetle-7",
            "b-negative-1-active": "$beetle-6",
            "b-negative-1-translucent": "hsla(348, 83%, 50%, 50%)",
            "b-negative-2": "$beetle-3",
            "b-warning-1": "$sunray-8",
            "b-warning-1-hover": "$sunray-7",
            "b-warning-1-active": "$sunray-6",
            "b-positive-1": "$botanic-8",
            "b-positive-1-hover": "$botanic-7",
            "b-positive-1-active": "$botanic-6",
            /* Icon */
            "icon-1": "$white",
            "icon-2": "$cloud-6",
