...
function stories() {
    return storiesOfBuilder(module, "Chromatic/Colors")
        .build();
}
         ...
         () =>
             <Stack gap={0}>
                 ...
                 <Inline gap={0}>
                     ...
                     <div className="pa4 bg-botanic-300" />
                     <div className="pa4 bg-botanic-400" />
                     <div className="pa4 bg-botanic-500" />
                     <div className="pa4 bg-botanic-600" />
                     <div className="pa4 bg-botanic-700" />
                     <div className="pa4 bg-botanic-800" />
                     <div className="pa4 bg-botanic-900" />
