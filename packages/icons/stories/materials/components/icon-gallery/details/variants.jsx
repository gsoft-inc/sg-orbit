...
function IconComponent({ componentType }) {
    return (
        <details>
            <summary>Use as a component</summary>
            <h4>Import</h4>
...
function ImageSource({ componentType, iconFileName, iconDisplayName }) {
    return (
        <details>
            <summary>As an image source</summary>
            <h4>Import</h4>
...
function CssBackground({ iconFileName, iconDisplayName }) {
    ...
    return (
        <details>
            <summary>As a CSS background</summary>
...
export function Variants({ iconDisplayName, variants }) {
    return (
        <>
            <h2>Variants</h2>
            <Tab panes={variants.map(x => ({ menuItem: x.name, render: () => <Variant iconDisplayName={iconDisplayName} {...x} /> }))} />
        </>
    );
}
