...
<Playground>
    <Label icon>
        <Label circular empty size="mini" color="red" />Group added
    </Label>
</Playground>
...
<Playground>
    <Label icon>
        <svg xmlns="http://www.w3.org/2000/svg" class="fill-marine-dark w5 h4 mr2" viewBox="0 0 25.5 19.5">
            <g data-name="Layer 2">
                <g data-name="Layer 1">
