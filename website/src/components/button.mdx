...
<Playground>
    <Button className="ghost">Prog</Button>
</Playground>

### Active / Focus

<Playground>
    <Button className="ghost" active>
        Prog
    </Button>
</Playground>
...
<Playground>
    <Button className="ghost" primary>
        Stage
    </Button>
</Playground>
...
<Playground>
    <Button className="ghost" primary active>
        Stage
    </Button>
</Playground>
...
<Playground>
    <Button className="ghost" primary disabled>
        Stage
    </Button>
</Playground>
...
<Playground>
    <Button icon>
        <svg class="flex" width="24" height="24" viewBox="0 0 31 20" xmlns="http://www.w3.org/2000/svg">
            <path
...
<Playground>
    <Button fluid>To the infinity and beyond</Button>
</Playground>
