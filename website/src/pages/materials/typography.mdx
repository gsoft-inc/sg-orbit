...
<Playground>
    <h1 class="lh1">If two pieces of the same type of metal touch in space they will permanently bond.</h1>
</Playground>

### Scale 2

<Playground>
    <h1 class="lh2">If two pieces of the same type of metal touch in space they will permanently bond.</h1>
</Playground>

### Scale 3

<Playground>
    <h1 class="lh3">If two pieces of the same type of metal touch in space they will permanently bond.</h1>
</Playground>

### Scale 4

<Playground>
    <h1 class="lh4">If two pieces of the same type of metal touch in space they will permanently bond.</h1>
</Playground>
