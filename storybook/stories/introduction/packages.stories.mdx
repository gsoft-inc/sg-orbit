...
Multiple packages compose Orbit UI. Based on which type of application you're building you'll choose a different composition of packages. For more information view the [installation page](?path=/docs/introduction-installation--page).
