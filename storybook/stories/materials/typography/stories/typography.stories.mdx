...
To match that, we needed a font that would reflect our personality: _fun_, _human_ and _helpful_. With its linear, geometric forms, its simplicity, clarity, and with its fun and perfect curves, [Calibre](https://klim.co.nz/retail-fonts/calibre/) is the perfect choice for us.
