...
<Table
    ...
    rows={[
        ["f1", "lh1", "500", <h1 className="f1 fw5 lh1 pv3">Migrate, adapt, and control the cloud.</h1>],
        ["f2", "lh1", "500", <h1 className="f2 fw5 lh1 pv3">Migrate, adapt, and control the cloud.</h1>],
...
<Table
    ...
    rows={[
        ["f4", "lh4", "fw4", <p className="f4 lh4 pv3">If two pieces of the same type of metal touch in space they will permanently bond.</p>],
        ["f5", "lh2", "fw4", <p className="f5 lh2 pv3">If two pieces of the same type of metal touch in space they will permanently bond.</p>],
        ["f6", "lh4", "fw4", <p className="f6 lh4 pv3">If two pieces of the same type of metal touch in space they will permanently bond.</p>],
        ["f7", "lh3", "fw4", <p className="f7 lh3 pv3">If two pieces of the same type of metal touch in space they will permanently bond.</p>],
        ["f8", "lh5", "fw4", <p className="f8 lh5 pv3">If two pieces of the same type of metal touch in space<br/> they will permanently bond.</p>],
        ["f9", "lh1", "fw4", <p className="f9 lh1 pv3">If two pieces of the same type of metal touch in space<br/> they will permanently bond.</p>]
    ]}
/>
...
<Table
    ...
    rows={[
        ["lh1", "1", <p className="lh1 pv3">If two pieces of the same type of metal touch in space they will permanently bond.</p>],
        ["lh2", "1.2", <p className="lh2 pv3">If two pieces of the same type of metal touch in space they will permanently bond.</p>],
        ["lh3", "1.25", <p className="lh3 pv3">If two pieces of the same type of metal touch in space they will permanently bond.</p>],
        ["lh4", "1.33333", <p className="lh4 pv3">If two pieces of the same type of metal touch in space they will permanently bond.</p>],
        ["lh5", "1.4285714286", <p className="lh5 pv3">If two pieces of the same type of metal touch in space they will permanently bond.</p>],
        ["lh6", "15", <p className="lh6 pv3">If two pieces of the same type of metal touch in space they will permanently bond.</p>]
    ]}
/>
