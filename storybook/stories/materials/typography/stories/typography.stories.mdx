...
Calibre is the font used through ShareGate's Products(print, web, app). When using a [custom installation](?path=/docs/getting-started-installation--page#custom-installation) you need to import the CSS, who takes care of loading Calibre, yourself.
...
<Figure url="https://raw.githubusercontent.com/gsoft-inc/sg-orbit/add-css-vars-to-doc/storybook/stories/materials/typography/stories/assets/vertical-rythm-in-action.png" caption="Vertical rythmh in action" />
