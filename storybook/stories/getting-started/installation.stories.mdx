...
Multiple [npm packages](?path=/docs/getting-started-packages--page) compose Orbit. Based on which type of application you're building you'll choose a different composition.

## React bundle

For a React application, the easiest way to use Orbit is by installing the [@orbit-ui/react](https://www.npmjs.com/package/@orbit-ui/react) bundle. The bundle will install all the [core](?path=/docs/getting-started-packages--page#core) and [React](?path=/docs/getting-started-packages--page#react-components) packages of Orbit in 3 easy steps.
