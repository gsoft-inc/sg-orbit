...
[Orbit icons](?path=/docs/materials-icons--page) depends on [@svgr/webpack](https://react-svgr.com/docs/getting-started/) to transform SVG icons files into React components. If you use Orbit icons React components or any Orbit React components, chances are you depend on `@svgr/webpack`. To use `@svgr/webpack`, your project babel config must also configure the [babel-plugin-named-asset-import](https://www.npmjs.com/package/babel-plugin-named-asset-import) plugin:
