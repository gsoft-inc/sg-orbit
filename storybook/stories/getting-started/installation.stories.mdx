...
[Orbit icons](?path=/docs/materials-icons--page) depends on [SVGR](https://github.com/gregberge/svgr) to transform SVG icons into React components. To use SVGR, your project babel config must configure the [babel-plugin-named-asset-import](https://www.npmjs.com/package/babel-plugin-named-asset-import) plugin:
