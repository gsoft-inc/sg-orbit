...
For any [brand](?path=/docs/materials-colours-sharegate--page) or [UI](?path=/docs/materials-colours-ui--page) colors, the following classes are available:
...
The colors of the Sharegate [products](?path=/docs/materials-colours-brands--page) have been added to Tachyons.

The brands colors classes support the same naming scheme as the other [colors](#skins) classes but use a [_product-name_] instead of a [_color-name_]. For any [products](?path=/docs/materials-colours-brands--page), the following classes are available:
