...
<PackagesTable
    packages={[
        ...
        { name: "@orbit-ui/react-icons", description: "The icons of Orbit UI as React components and a few components to standardize icons size.", relativePath: "packages/react-components/components/icons" },
        ...
        { name: "@orbit-ui/react-select", description: "Standalone select component.", relativePath: "packages/react-components/components/select" },
