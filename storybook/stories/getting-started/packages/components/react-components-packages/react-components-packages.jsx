...
export function ReactComponentsPackages() {
    ...
    //     const context = require.context("@root/packages/react-components/src", true, /\/package.json/, "eager");
    ...
    //     { name: x.manifest.name, description: x.manifest.description, relativePath: `packages/react-components/src/${x.name}` }
    // ));
