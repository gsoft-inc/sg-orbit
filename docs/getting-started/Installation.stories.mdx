...
Below is an example of how to configure an application with a *pre-constructed* ShareGate [theme](?path=/story/theming--page#option-3-retrieve-a-pre-constructed-theme-from-orbit) object:
