...
| ![theme-vs-color-scheme.jpg](https://raw.githubusercontent.com/gsoft-inc/sg-orbit/master/rfcs/assets/color-scheme.jpg?raw=true) |
| :----------------------------------------------------------: |
|       *Color Schemes affects the whole look of an app*       |

| ![theme-vs-color-scheme.jpg](https://raw.githubusercontent.com/gsoft-inc/sg-orbit/master/rfcs/assets/theme.png?raw=true) |
| :----------------------------------------------------------: |
| *Themes affects specific colors, they express the personallity of different brands* |
...
Using Orbit theme provider is easy, import `ThemeProvider` and give it the necessary props.
