...
## Install packages Experimental Components

To install Orbit's experimental component, open a terminal at the root of your project workspace and run the following command:

<PackageInstallationSnippet packageName="experimental" />

The command will install Orbit's experimental package in the `node_modules` folder of your application.
...
@import "~@orbit-ui/experimental/index.css"; /* For experimental components */
```
