...
Once installed, for Orbit UI components to use your product theme, you must declare a [`ThemeProvider`](?path=/docs/theme-provider--default-story) at the root of your application.
