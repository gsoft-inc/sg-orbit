...
Once installed, for Orbit UI components to Apricot style or any other theme styles, you must declare a [`ThemeProvider`](?path=/docs/theme-provider--default-story) at the root of your application.
