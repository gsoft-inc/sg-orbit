...
For a React application, the easiest way to use Orbit UI is by installing the [@orbit-ui/react](https://www.npmjs.com/package/@orbit-ui/react) bundle. The bundle will install the [core](?path=/docs/packages--page#core) and [React](?path=/docs/packages--page#components) packages of Orbit UI in 5 easy steps.
