...
const ScaleLinks = {
    ...
    "color-scale": <Link href="?path=/story/colors--page">[color]-[1..10]</Link>,
...
function toRowValues([propName, cssProperty, theming, scale, supports]) {
    return [
        propName,
        cssProperty,
        theming,
    ...
    return (
        <Table
            columns={[
                ...
                { title: "Theming", headerStyle: { width: "125px" }, rowClassName: "code" },
