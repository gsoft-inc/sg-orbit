...
Not all breakpoints needs to be explicitly set as the system is robust enough to fill in the voids, meaning that base and lg would be valid breakpoints, xl would takes the value set by lg since it is wider than lg.
