...
<Preview>
    <Div width={18} backgroundColor="alias-accent-light" padding={4} borderRadius="rounded" maxWidth="100%">
...
<Preview>
    <Div backgroundColorHover="alias-success-light" backgroundColor="alias-warning-light" padding={4} width={18} maxWidth="100%" borderRadius="rounded">
        <Paragraph fontSize={4}>Lost in space.</Paragraph>
    </Div>
</Preview>
