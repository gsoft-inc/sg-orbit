...
Orbit supports a *light* and a *dark* color scheme within a theme and offers, out of the box, color schemes support for all components and [tokens](?path=/story/tokens--page), where applicable.
